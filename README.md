...
- [Click here to Deploy this project.](https://dash.deno.com/new?url=https://raw.githubusercontent.com/kooldood-1/ActivitiesBot-main/master/mod.ts?token=GHSAT0AAAAAABOWUZGH4VW3RNAO3XR66IXSYROBM7Q and enter your bot's token (Bot -> Copy Token) and public key (General -> Copy Public Key), available on [Discord Developer Portal](https://discord.dev).
